    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="portfolioFilter">
                ...
                <a href="#" data-filter=".{{ $kategori->jenis }}" class="waves-effect waves-primary">{{ $kategori->jenis }}</a>
                @endforeach
            </div>
    ...
    <div class="port">
        <div class="row mb-2 justify-content-end">
            <div class="col-md-3">
                ...
                <input class="form-control me-2" type="search" name="query" id="search" placeholder="Cari Barang..." aria-label="Search">
                </form> --}}
            ...
            <div class="col-md-6 col-xl-3 {{ $barang->kategori->jenis }}">
                ...
                <form id="addProduct" wire:submit.prevent='addToCart({{ $barang->id }})'>
                    ...
                    <button class="btn btn-danger w-100
                                            @if (auth()->check() && auth()->user()->is_admin == 1) d-none @endif
                                            @if (auth()->check() == 0) d-none @endif"><span class="mdi mdi-cart"></span></button>
                </form>
            </div>
        </div>
        </a>
