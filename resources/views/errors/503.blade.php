...
<head>
    <meta charset="utf-8" />
    <title>Maintenance | Adminto - Responsive Admin Dashboard Template</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <div class=" p-4 mx-auto">
                            <img class="img-fluid bg-black rounded"
                                src="{{ url('storage/logo/piat7-transparent.png') }}" alt="">
                        </div>
                        ...
                        <div class="">
                            <h3 class="mt-4">Oops!, Website sedang dalam perbaikan</h3>
                            <p class="text-muted">Kami sedang membuat sistem lebih <strong>MUMTAZ</strong> . Kami akan
                                segera kembali <strong>insyaallah</strong>.</p>
                        </div>
